...
| `2026-08-21` | [Pi-Cordis 移除 Cordis 内置源码并直连官方 npm 包](implemented/simplification/2026-08-21-pi-cordis-official-cordis-npm-dependencies.zh.md) | 移除 `vendor/`，从 npm 解析官方 Cordis、CosmoKit、Schemastery，并统一测试与生产运行时的依赖路径 |
