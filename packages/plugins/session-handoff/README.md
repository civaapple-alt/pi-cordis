...
Collapsed TUI output stays compact, while expanded output renders the complete Markdown envelope so a receiving developer can review every goal, constraint, completed item, next step, and verification command before using it.
